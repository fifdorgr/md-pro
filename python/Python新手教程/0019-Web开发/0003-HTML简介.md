...
```
可以用文本编辑器编写HTML，然后保存为h``]ello.html`，双击或者把文件拖到浏览器中，就可以看到效果：

![hello.html](http://emanual.github.io/md-python/img/tutorial/0019-0003-01.jpeg)
...
![hello-css](http://emanual.github.io/md-python/img/tutorial/0019-0003-02.jpeg)
...
![hello-js-change-color](http://emanual.github.io/md-python/img/tutorial/0019-0003-03.jpeg)
