...
![flask-home](http://emanual.github.io/md-python/img/tutorial/0019-0005-01.png)

首页显示正确！

再在浏览器地址栏输入`http://localhost:5000/signin`，会显示登录表单：

![flask-signin-form](http://emanual.github.io/md-python/img/tutorial/0019-0005-02.png)

输入预设的用户名admin和口令password，登录成功：

![flask-signin-ok](http://emanual.github.io/md-python/img/tutorial/0019-0005-03.png)

输入其他错误的用户名和口令，登录失败：

![flask-signin-failed](http://emanual.github.io/md-python/img/tutorial/0019-0005-04.png)
